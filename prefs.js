...
export default class RunPikaPreferences extends ExtensionPreferences {
	#settings = null
	#builder = null
	#window = null
	...
	async fillPreferencesWindow(window) {
		...
		this.#window.title = _('RunPika Settings')
	...
	#setupMenu() {
		...
		aboutAction.connect('activate', () => {
			const logo = Gtk.Image.new_from_file(`${this.path}/resources/runpika.svg`)
